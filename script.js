    ...
    function handleImageErrors() {
        ...
        images.forEach(img => {
            img.addEventListener('error', function() {
                ...
                // Для логотипа проекта Белый след
                ...
                // Для изображения Резерв Белого следа
                if (this.src.includes('finlanov-partiya')) {
                    ...
                    if (!placeholder.querySelector('.reserve-fallback')) {
                        ...
                        const text = document.createElement('p');
                        text.textContent = 'Резерв Белого следа';
